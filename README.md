...
분석 결과, 전체 직원 중 약 30% 이상이 근속 5년 이내에 퇴사하며, 특히 입사 1년 이내 생존 확률은 약 85%로 가장 가파르게 감소하는 양상을 보였다. 반면, 4년차 이후부터는 생존 곡선이 완만해지고, 10년 이상 장기 근속자의 이탈률은 매우 낮은 수준을 유지하는 것으로 나타났다.
